...
(except the legacy `/api/generate`, public at the time and retired in ticket 09) is gated behind it; after
...
- [x] Legacy `/api/generate` behaviour unchanged and still public (retired later, ticket 09 — route removed; anon hits the auth gate before the 404 fallthrough)
